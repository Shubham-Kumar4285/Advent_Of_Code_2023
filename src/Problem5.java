...
//        int point=0;
//        while(point<NewSeeds.size()){
//            Long lb=NewSeeds.get(point).get(0);
//            Long ub= NewSeeds.get(point).get(1);
//            for (int j=0;j<temp.size();j++
//            ) {
...
////                               if(target.getMinimum()==mapping.getMinimum() && target.getMaximum()==mapping.getMaximum()){
...
//
//                                       NewSeeds.add(discardedRange1);
//                                       NewSeeds.add(discardedRange2);
//                                       lb=a+(destination-source);
//                                       ub=b+(destination-source);
//                                       break;
//
...
//
//                    }
//                    //test case-after soil
//
//
//                }
//                //test-case -2 after water
////                if(j>=18 && point==1) {
////                    ArrayList<Long> replaceRange = new ArrayList<>();
////                    replaceRange.add(lb);
////                    replaceRange.add(ub);
////                    NewSeeds.set(point, replaceRange);
////
////                    System.out.println(NewSeeds);
////
////                    System.exit(0);
...
//        for (ArrayList<Long> item:NewSeeds
//             ) {
//            if(item.get(0)<min3){
//                min3=item.get(0);
//            }
